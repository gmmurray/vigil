/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareBindings` (hash: 9e222a37823963c36dcf7d6586916cdf)
...
declare namespace Cloudflare {
	interface GlobalProps {
		...
		durableNamespaces: "MonitorObject";
	}
	interface Env {
		CHECK_RESULTS_RETENTION_DAYS: "15";
		MONITOR: DurableObjectNamespace<import("./src/worker/index").MonitorObject>;
		DB: D1Database;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "CHECK_RESULTS_RETENTION_DAYS">> {}
}
